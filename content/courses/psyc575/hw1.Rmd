...
In this first assignment, you will Find a published research article in your area of research in which the authors have used a multilevel analysis. You fill then find out some basic information from the article. You will then post that, together with a quick introduction of yourself, on the Discussion Board. Complete the two parts (article search and self-introduction) of the assignment by **August 21**. This assignment is worth 6 points. 

## Steps

1. Find a journal article that reported results of a multilevel analysis in your field.
2. Go to the Google spreadsheet at https://docs.google.com/spreadsheets/d/18jdCyfu5eqFQ30YblABft-o5F5ozY5SdO2E7Z3ZYJCs. In a new row, record the following information from the article:
...
3. Introduce yourself on Blackboard
    a. Go to the "Introduction" forum on the Discussion Board
    b. Click on **Create Thread**
    c. Enter a title in the **Subject** field
    d. In the **Message** box, write 
        i. a brief description of your background (e.g., your major, research interest)
        ii. the reason of taking this course
        iii. your experience of using R or other statistical packages
        iv. Something else about yourself that you want to share with the class
    e. (Optional) Review and comment on peer postings
